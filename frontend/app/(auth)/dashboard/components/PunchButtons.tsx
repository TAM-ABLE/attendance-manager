      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 px-4 sm:px-0">
          ...
          <Button
            ...
            size="lg"
            className={`h-20 sm:h-24 flex-col gap-2 w-full sm:w-[300px] md:w-[400px] text-lg sm:text-xl font-semibold ${
              !isWorking && !onBreak
        ...
        <div className="flex justify-center px-4 sm:px-0">
          ...
          {!onBreak ? (
            <Button
              ...
              size="lg"
              className={`h-20 sm:h-24 flex-col gap-2 w-full sm:w-[300px] md:w-[400px] text-lg sm:text-xl font-semibold ${
                isWorking ? "bg-lime-500 text-white hover:bg-lime-600" : "bg-gray-200 text-gray-400"
              }`}
            >
