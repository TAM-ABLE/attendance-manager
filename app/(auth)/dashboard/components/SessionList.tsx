...
import { calculateActiveSession, calculateCompletedSession } from "@/lib/calculation"
import { formatClockTime, formatDurationMs } from "@/lib/time"
import type { AttendanceRecord, WorkSession } from "@/types/Attendance"
            ...
            <div key={s.id} className="border rounded-lg p-4 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="bg-primary/10 border border-primary/30 rounded-md p-3">
                  ...
                  <p className="text-base sm:text-lg text-primary">{formatDurationMs(workMs)}</p>
                </div>
